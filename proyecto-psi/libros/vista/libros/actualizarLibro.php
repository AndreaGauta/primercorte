...
<html lang="en">
  ...
  <body>
    <div class="container">
                ...
                <?php
                    try{
                        if(!isset($_REQUEST["lib_id"])){
                            throw new Exception("Por favor ingrese el Id del libro");
                        }
                        ...
                        $dependencia->setDepNombre($lib_nombre);
                        $dependencia->setLibFechaPrestamo($lib_fecha_prestamo);
                        $libro->setLibFechaEntrega($lib_fecha_entrega);


                        $LibroController = new LibroController;

                        $resultado = $LibroController->actualizar($libro);
        ...
        <div class="row">
            <div class="col-md-12">
                <a href="listarLibros.php" class="btn btn-primary">Regresar al listado</a>
            </div>
        </div>
    </div>
